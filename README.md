...
```bash
docker build --target development --no-cache --tag cdp-example-node-postgres-be:development .
```

Run:

```bash
docker run -e PORT=3001 -p 3001:3001 cdp-example-node-postgres-be:development
```
...
```bash
docker build --no-cache --tag cdp-example-node-postgres-be .
```

Run:

```bash
docker run -e PORT=3001 -p 3001:3001 cdp-example-node-postgres-be
```
